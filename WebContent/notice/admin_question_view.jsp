...
<div id = "mypage_qna">
   <div id = "qna_top">
      ...
      <ul>
         <li>총 문의 <span>${fn:length(list)}</span> 건</li>
      </ul>   
   </div>
   <table class = "tbl_qna" cellspacing="0" cellpadding = "0">
      ...
      <tbody>
         <c:forEach var = "data" items="${list }">
            <tr onclick = "gorepl('${data.qSerial }')" style="cursor: pointer;">
...
function gorepl(serial) {
   getId("qSerial").value = serial;
   frm.action = "index.jsp?content=question_answer.not";
   frm.submit();
}
